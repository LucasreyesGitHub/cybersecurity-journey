...
Si se trata de una amenaza real, puede **escalarse al equipo SOC L2**.

---

# Laboratorio Práctico

El room incluye un entorno simulado de SOC donde se practican tareas como:
...
Esto permite practicar **flujos de trabajo reales de un SOC**.

---

# Conclusiones

Este room enseña los fundamentos del **análisis de alertas en un SOC**.

Conceptos clave aprendidos:

- Diferencia entre eventos y alertas
- Plataformas de seguridad utilizadas en SOC
- Roles dentro de un equipo SOC
- Proceso de triage de alertas
- Clasificación de incidentes

El **alert triage** es una habilidad fundamental para cualquier **analista SOC nivel 1**.
